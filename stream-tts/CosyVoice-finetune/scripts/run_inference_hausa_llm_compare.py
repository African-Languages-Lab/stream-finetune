"""
Isolates the llm stage for Hausa: a real voice prompt + its real transcript, and a real
target text, both from ha-NG's own training data, synthesized with our finetuned ha-NG llm
(highest checkpoint) vs the original pretrained llm. flow and hifigan are the ORIGINAL
pretrained weights in both cases -- vocoder finetuning is retired, and holding flow constant
too isolates whatever difference is heard to the llm alone.
...
WORK_ROOT = "/leonardo_scratch/large/userexternal/atsado00/cosyvoice_ft/bundle_hausa_llm_compare"
OUT_DIR = "/leonardo_scratch/large/userexternal/atsado00/cosyvoice_ft/inference_hausa_llm_compare"
...
FINETUNED_LLM = "/leonardo_scratch/large/userexternal/atsado00/cosyvoice_ft/checkpoints/individual/individual_ha-NG/llm/epoch_16_whole.pt"
